    ...
    return (
      <div className="bg-white p-12 rounded-[40px] shadow-2xl border border-red-50 text-center">
        ...
        <p className="text-slate-500 mb-8 text-sm leading-relaxed">
          Our vascular specialist will get in touch with you shortly.
        </p>
        <button
          onClick={() => {
            setSubmitted(false);
...
export default function VascularSurgeryPageClient() {
        ...
        <section className="py-20 px-6 bg-slate-900 text-white text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-slate-400 text-lg mb-10">
              Our vascular specialist will get in touch with you shortly after your enquiry.
            </p>
