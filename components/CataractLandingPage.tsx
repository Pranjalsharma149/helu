  ...
  return (
    <div className="clp2">
      <style>{`
        ...
        /* Wraps the badge + the image box. Badge is a SIBLING of the image
           box, not a child — so it can never be clipped/overlapped inside
           the image's rounded border on any breakpoint. */
        .clp2-hero-visual-wrap { position: relative; height: 100%; min-width: 0; }
        ...
        .clp2-hero-iso-badge .dot { width: 7px; height: 7px; border-radius: 50%; background: var(--accent-deep); flex-shrink: 0; }
        ...
        @media (max-width: 900px) {
          ...
          .clp2-hero-visual-wrap { order: -1; height: auto; }
        ...
        @media (max-width: 560px) {
          ...
          /* Badge lives OUTSIDE the image box on mobile: stack it as its
             own row above the image instead of overlapping/clipping. */
          .clp2-hero-visual-wrap {
            display: flex;
      ...
      <section className="clp2-hero">
        <div className="clp2-wrap">
          <div className="clp2-hero-grid">
            ...
            {/* Badge is a SIBLING of the image box (not nested inside it),
                so it's never clipped by the image's rounded border/overflow.
                Desktop: absolutely positioned back on top of the image.
                Mobile: static, stacked above the image as its own row. */}
            <div className="clp2-hero-visual-wrap">
              <div className="clp2-hero-iso-badge">
                <span className="dot" />
