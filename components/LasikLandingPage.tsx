...
.llp-hero-visual { position: relative; border-radius: 16px; overflow: hidden; border: 1px solid var(--line); height: 100%; min-width: 0; }
        ...
        .llp-hero-iso-badge .dot { width: 7px; height: 7px; border-radius: 50%; background: var(--accent-deep); flex-shrink: 0; }
        ...
        <div className="llp-wrap">
          <div className="llp-hero-grid">
            ...
            <div className="llp-hero-visual">
              ...
              <div className="llp-hero-iso-badge">
                <span className="dot" />
